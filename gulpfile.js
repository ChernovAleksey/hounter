...
const buildttf = () => gulp.src("./src/font/*.ttf").pipe(gulp.dest("./dist/fonts/"));

const innerbuild = gulp.series(buildCSS, buildJS);
export const build = gulp.series(cleanDist, gulp.parallel(buildCSS, buildJS, buildttf, imgMinify))
